...
import { addTask, addTasks } from '../store/tasksSlice';
import { setStatus } from '../store/filterSlice';
...
function TasksScreen() {
  ...
  const statusFilter = useAppSelector((state: RootState) => state.filters.statusFilter )
